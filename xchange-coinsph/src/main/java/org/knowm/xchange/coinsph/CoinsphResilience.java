...
public final class CoinsphResilience {
  ...
  public static ResilienceRegistries createRegistries() {
    ...
    // From docs: "The combined weight of all requests using an API key cannot exceed 1200 per minute."
    ...
    // Example: Retry on 429 (Too Many Requests) if not handled by RateLimiter, or 5xx server errors.
    registries
        .retries()
        .retry(
